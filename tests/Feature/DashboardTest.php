...
class DashboardTest extends TestCase
{
    ...
    public function test_dashboard_shows_explicitly_demonstrative_data_and_disabled_order_actions(): void
    {
        ...
        $this->actingAs($user)->get('/dashboard')
            ...
            ->assertSee('Dati dimostrativi.')
            ->assertSee('Atelier Centro')
            ->assertSee('Spedizioni in corso')
            ->assertSee('disabled aria-describedby="demo-actions-note"', false);
