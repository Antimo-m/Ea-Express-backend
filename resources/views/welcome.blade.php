<x-guest-layout title="Benvenuto">
    ...
    <div class="form-stack">
        ...
        @else<a class="btn btn-primary" href="{{ route('login') }}">Accedi al tuo account <x-ui.icon name="arrow-right" class="ms-2" /></a>@if(config('access.registration'))<a class="btn btn-outline-secondary" href="{{ route('register') }}">Crea un account</a>@endif
@endauth
    </div>
</x-guest-layout>
