<nav class="mobile-nav d-lg-none" aria-label="Navigazione rapida">
    ...
    @endforeach
    <button type="button" @class(['nav-item-link', 'compact', 'active' => ! request()->routeIs('dashboard', 'orders.incoming', 'orders.in-progress', 'messages.index')]) data-bs-toggle="offcanvas" data-bs-target="#app-navigation" aria-controls="app-navigation" aria-label="Apri tutte le sezioni"><x-ui.icon name="list" /><span>Altro</span></button>
</nav>
