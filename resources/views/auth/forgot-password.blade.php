<x-guest-layout title="Recupera password">
    ...
    <h2 class="auth-title mt-4">Ritrova l'accesso.</h2><p class="text-secondary mb-4">Inserisci la tua email. Ti invieremo un link per scegliere una nuova password.</p>
