<x-guest-layout title="Registrati">
    <span class="eyebrow">IL TUO SPAZIO EA-EXPRESS</span><h2 class="auth-title">Iniziamo, insieme.</h2><p class="text-secondary mb-4">Crea il tuo account per accedere alla piattaforma.</p>
