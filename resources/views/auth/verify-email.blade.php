<x-guest-layout title="Verifica email">
    <span class="eyebrow">UN ULTIMO PASSAGGIO</span><h1 class="auth-title">Controlla la tua email.</h1><p class="text-secondary mb-4">Apri il link che ti abbiamo inviato per verificare il tuo indirizzo. Se non lo trovi, puoi richiederne un altro.</p>
